...
<style>
    ...
    /* Input Styles */
    /* Input Styles - COMPLETE FIX for text AND cursor */
    .stTextInput > div > div > input {
        ...
        caret-color: var(--gray-900) !important;  /* FIX CURSOR COLOR */
    }
    ...
    .stTextInput > div > div > input:focus {
        ...
        color: var(--gray-900) !important;
        caret-color: var(--primary-blue) !important;  /* BLUE CURSOR ON FOCUS */
    }

    /* Additional targeting for all input variants */
    .stTextInput input {
        color: var(--gray-900) !important;
